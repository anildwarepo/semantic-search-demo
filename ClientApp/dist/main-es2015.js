...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h3>Semantic Search with Azure Cognitive Search Service</h3>\r\n");
...
/* harmony import */ var _helper_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./helper.component */ "./src/app/helper.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot([
                { path: '', component: _search_search_component__WEBPACK_IMPORTED_MODULE_8__["SearchComponent"], pathMatch: 'full' },
...
let HelperComponent = class HelperComponent {
    ...
    callApi(apiPath) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield this.http.get("http://127.0.0.1:5000/api/" + apiPath).toPromise();
            return JSON.stringify(result, null, 2);
        });
    }
    postToAPi(apiPath, data) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield this.http.post("http://127.0.0.1:5000/api/" + apiPath, data).toPromise();
            return JSON.stringify(result, null, 2);
        });
    }
};
HelperComponent.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _helper_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helper.component */ "./src/app/helper.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let SearchComponent = class SearchComponent {
    ...
    getSearchResults(apiPath) {
        return __awaiter(this, void 0, void 0, function* () {
            this.result = "fetching...";
            this.result = yield this.helper.postToAPi(apiPath, this.searchQuery);
    ...
    getSearchIndex() {
        return __awaiter(this, void 0, void 0, function* () {
            this.result = "fetching...";
            this.result = yield this.helper.callApi("indexes");
...
SearchComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_helper_component__WEBPACK_IMPORTED_MODULE_1__["HelperComponent"]])
], SearchComponent);
...
module.exports = __webpack_require__(/*! C:\source\repos\semantic-search\webapp\ClientApp\src\main.ts */"./src/main.ts");
